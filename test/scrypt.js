...
describe("scrypt.js", () =>
{
  async function compare(password, salt, length, expected)
  {
    ...
    expect(new Uint8Array(result).join(",").split(",")).to.deep.equal(expected);
  }

  it("should produce expected results for example input", async function()
  {
    await compare("", "", 64, `
    ...
    await compare("password", "salt", 64, `
    ...
    await compare("passwordPASSWORDpassword", "saltSALTsaltSALTsaltSALTsaltSALTsalt", 64, `
    ...
    await compare("pass\0word", "sa\0lt", 64, `
