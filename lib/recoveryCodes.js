...
import {getPassword} from "./passwords.js";
import {getSalt, deriveKeyWithPassword} from "./masterPassword.js";
...
export async function getCode(passwordData)
{
  ...
  let encrypted = await encrypt(password, undefined, false);
