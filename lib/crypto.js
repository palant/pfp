...
{
  return deriveBits(password, salt, AES_KEY_SIZE / 8).then(array =>
  {
...
exports.encryptPassword = function(params)
{
  ...
  return Promise.resolve().then(() =>
  {
    return deriveKey(params.masterPassword, salt, "encrypt");
  }).then(key =>
  {
...
exports.decryptPassword = function(params)
{
  ...
  return Promise.resolve().then(() =>
  {
    return deriveKey(params.masterPassword, salt, "decrypt");
  }).then(key =>
  {
