...
Cu.importGlobalProperties(["crypto", "TextEncoder", "TextDecoder", "atob", "btoa"]);
...
exports.derivePassword = function(params, callback)
{
...
exports.encryptPassword = function(params, callback)
{
  Promise.resolve(true).then(() =>
  {
    return crypto.subtle.importKey(
...
exports.decryptPassword = function(params, callback)
{
  Promise.resolve(true).then(() =>
  {
    return crypto.subtle.importKey(
