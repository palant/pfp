...
function deriveBits(password, salt, length)
{
  ...
  {
    if (!scryptWorker)
      scryptWorker = new Worker(require("./browserAPI").runtime.getURL("worker/scrypt.js"));
...
function deriveBitsLegacy(password, salt, length)
{
  ...
  {
    if (!pbkdf2Worker)
      pbkdf2Worker = new Worker(require("./browserAPI").runtime.getURL("worker/pbkdf2.js"));
...
const base32Alphabet = exports.base32Alphabet = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789";
