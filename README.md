...
In order to build PfP you will need to install [Node.js](https://nodejs.org/) first (Node 13.8.0 or higher is required). You will also need [Gulp](http://gulpjs.com/), run the following command to install it (administrator privileges required):
